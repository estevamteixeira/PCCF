...
/*  PCCF+ Version 8A 																					*/
/*                                                                                                      */
/*  SAS routine for automated geographic coding from postal codes using the Postal Code Conversion      */
...
/*  are also included as an output PDF with a summary of geocoding results and several additional       */
...
/*  Statistics Canada, RHC-24A, 100 Tunney's Pasture Driveway, Ottawa ON  K1A 0T6                       */
/*  Support can be obtained at fe-hirddirs@statcan.gc.ca                                                */
/*                                                                                                      */
/********************************************************************************************************/
...
/*      - Folder path must NOT have any spaces                    										*/
...
/*      - Default for the input file is a .sas7bdat file (regular SAS file)                             */
...
* Data library (folder path where dataset is located);
libname inData "\\hird1\Saslibe$\PCCFplus_FCCPplus\Processing\Programs\PCCF8A1\sample";

* Data file name (no file extension permitted here);
%let inFile = sampledat;


/* Code to read text file into a SAS dataset - remove stars at beginning of each line to active this code */
/*filename sampdat   "&installDir.\Sample\link_source_C.txt";  /* input data in text format */
/*data inData.&infile.;
...
/********************************************************************************************************/
/* 3. Output data library and file name (the problem file is indicated with a "_problem" suffix)        */

* Output data library (folder path where processed data files will be output);
...
/********************************************************************************************************/
/* 4. Specify the output path and filename for the output summary (in PDF format)                       */
/*    This output includes both the former HLTHOUT and GEOPROB files.                                   */
%let pdfOutput = "\\hird1\Saslibe$\PCCFplus_FCCPplus\Processing\Programs\PCCF8A1\sample\sample_01.pdf";


/********************************************************************************************************/
/* 5. Version to run either Residential or Institutional coding (residential is default)                */
...
/*      - Random seed value                                                                             */
/*      - Length of unique identifier (ID) field                                                        */
/*                                                                                                      */
/********************************************************************************************************/
/********************************************************************************************************/
